Ext.define('Ticket.view.dashboard.Dashboard', {
    ...
    {
        xtype: 'container',
        itemId: 'toggleContainer', // Adding itemId for easy reference
        layout: {
            type: 'hbox',
            align: 'stretch'
        },
    ...
    },
    {
        ...
        handler: 'toggleContainer', // Call the toggleContainer method when button is clicked
        docked: 'bottom', // Dock the button to the bottom of the panel
        margin: '0 30 30 0', // Add margin to position it to the bottom-right corner
        hidden: false // Initially hide the button
    }
